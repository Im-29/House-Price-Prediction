...
form.addEventListener("submit", async function (e) {
  ...
  if (submitbutton === "PredictButton") {
    ...
    try {
      const res = await fetch("https://python-api-7xbz.onrender.com/predict", {
        method: "POST",
        headers: {
  ...
  if (submitbutton === "SaveButton") {
    ...
    fetch("https://house-price-prediction-1943.onrender.com/send-message", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
    ...
    fetch("https://house-price-prediction-1943.onrender.com/save-history", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
